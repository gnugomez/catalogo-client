<template>
  <div>
    ...
    >
      <p>
        El presente Política de Privacidad establece los términos en que Mis
        Películas usa y protege la información que es proporcionada por sus
      ...
      <p>
        ...
        podrán ser cancelados en cualquier momento. Mis Películas está altamente
      ...
      <p>
        ...
        cookies en cualquier momento desde su ordenador. Sin embargo las cookies
        ayudan a proporcionar un mejor servicio de los sitios web, estás no dan
        ...
        el uso de cookies, sin embargo la mayoría de navegadores aceptan cookies
      ...
      <p>
        ...
        requerido por un juez con un orden judicial. Mis Películas Se reserva el
